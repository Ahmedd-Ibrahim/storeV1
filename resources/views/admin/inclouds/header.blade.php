...
<head>
  ...
  <title>panal @yield('title')</title>

  <!-- Custom fonts for this template-->
<link href="{{url('backend/css/all.min.css')}}" rel="stylesheet" type="text/css">
<link href="{{url('backend/datatables/dataTables.bootstrap4.min.css')}}" rel="stylesheet" type="text/css">
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
          ...
          <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <h6 class="collapse-header">MEMBER SETTINGS:</h6>
              <a class="collapse-item" href="{{url('admin/members')}}">Members</a>
              <a class="collapse-item" href="{{url('admin/moderators')}}">Moderators</a>
              <a class="collapse-item" href="{{url('admin/border')}}">Admins</a>
              <a class="collapse-item" href="{{url('admin/animation')}}">Comments</a>
              <a class="collapse-item" href="{{url('admin/other')}}">Other</a>
            </div>
          </div>
        </li>
         <!-- End Nav members - members Collapse Menu -->
        ...
        <li class="nav-item">
          ...
          <div id="collapseitems" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <h6 class="collapse-header">items SETTINGS:</h6>
         ...
         <!-- End Nav Item - items Collapse Menu -->
        ...
        <li class="nav-item">
          ...
          <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="{{url('admin/forget')}}">Forgot Password</a>
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{Auth::user()->name == 'zezo' ? 'Admin' : Auth::user()->name}}</span>
