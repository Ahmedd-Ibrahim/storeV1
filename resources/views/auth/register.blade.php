          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form method="POST" action="{{ route('register') }}" class="user">
                  ...
                  <div class="form-group row">
                    <div class="col-sm-12 mb-3 mb-sm-0">
                  <input type="email" class="form-control form-control-user @error('email') is-invalid @enderror" id="exampleInputEmail" placeholder="Email Address" name="email"value="{{ old('email') }}" required autocomplete="email">
                </div>
                  @error('email')
              ...
              @enderror
                ...
                <div class="form-group row">
                    <div class="col-sm-12 mb-3 mb-sm-0">
                        ...
                        <input id="phone" type="number" class="form-control  form-control-user  @error('phone') is-invalid @enderror" placeholder="Phone Number" name="phone" value="{{ old('phone') }}" required autocomplete="phone">

                        @error('phone')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message = 'this phone number is exist' }}</strong>
                            </span>
                        @enderror
                    </div>
                </div>
